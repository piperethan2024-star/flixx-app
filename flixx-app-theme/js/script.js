...
const global = {
    ...
    api: {
      apiKey: 'd61a35e60e745b0a4fdf4b580cee77dc',
...
async function displayShowDetails() {
    ...
    div.innerHTML = `<div class="details-top">
          ...
          <div>
            ...
            <a href="#" target="_blank" class="btn">Visit TV Homepage</a>
          </div>
        </div>
        <div class="details-bottom">
          <h2>Show Info</h2>
...
function displayPagination() {
  ...
  {
    global.search.page++ // increment search page
...
// Show Alert. Default to error unless otherwise specified
...
const path = '/11-flix-app-project/flixx-app-theme'
// Init App
function init() {
    switch(global.currentPage) {
        ...
        case path + '/index.html':
            ...
            displaySlider();
            break;
        case path + '/shows.html':
            displayPopularShows();
            break;
        case path + '/movie-details.html':
            displayMovieDetails();
            break;
        case path + '/tv-details.html':
            displayShowDetails();
            break;
        case path + '/search.html':
            search()
            break;
    }
    highlightActiveLink();
